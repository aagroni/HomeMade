 ...
 *   https://datatables.net/download/#bs-3.3.7/jqc-1.12.4/dt-1.10.13
 *
 * Included libraries:
 *   Bootstrap 3.3.7, jQuery compat 1.12.4, DataTables 1.10.13
 */
...
(function(h) {
    ...
    m.ext = x = {
        buttons: {},
        classes: {},
        build: "bs-3.3.7/jqc-1.12.4/dt-1.10.13",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
...
(function(b) {
    ...
    b.extend(!0, f.defaults, {
        dom: "<'row'<'col-sm-2 pull-right'l><'col-sm-3 pull-right'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        renderer: "bootstrap"
    });
